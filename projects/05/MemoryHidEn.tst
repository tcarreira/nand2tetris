...
output-list in%D1.6.1 enable%B2.1.2 hide%B2.1.2 load%B2.1.2 address%B1.15.1 out%D1.6.1;
...
// Now we run the same thing with enable off and hide off
...
// Now we run the same thing, but with enable on and hide on
...
// Now we run the same thing, but with enable off and hide on
